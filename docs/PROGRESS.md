...
| P4 — Marketing Analytics | [phases/P4_MARKETING_ANALYTICS.md](./phases/P4_MARKETING_ANALYTICS.md) | Complete |
...
- Integration suite is **51 tests**: auth 10, tenant isolation 6, commerce 14, content 12, SEO auditor 4, marketing analytics 5 (each suite run individually — the shared test DB races under parallel file execution).
